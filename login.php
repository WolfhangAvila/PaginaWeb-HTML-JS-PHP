...
<html>
	...
	<body>
        ...
        <header id="header" class="bar">
            <div class="logo"><a href="index.php">GameShop</a></div>
            ...
            <section class="wrapper style2">
                <br>
                <h2 class="align-center">Regístrate</h2>
                <br><br>
                <div class="itembox">
                        ...
                        <div class="row uniform">
                            ...
                            <div class="12u$ align-center">
                                ...
                                <ul class="actions">
                                    ...
                                    <li><a class="button alt" href="signup.php">Iniciar sesion</a>
                                </ul>
                                <br>
                            </div>
                        </div>
			...
			<footer id="footer">
				<div class="container">
					<ul class="icons">
                    <li><a href="https://www.instagram.com/wolfhang_avila/" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
					</ul>
				</div>
			</footer>
